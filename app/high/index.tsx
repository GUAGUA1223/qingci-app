  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.headerSection}>
        ...
        <Image source={foxImages.graduate} style={styles.foxImage} resizeMode="contain" />
      ...
      <View style={styles.buttonsSection}>
        <TouchableOpacity style={styles.bigButton} onPress={handleLearn} activeOpacity={0.8}>
          ...
          <View style={styles.buttonTextRow}>
            ...
            <Text style={styles.bigButtonSubLabel}>高考词汇·高频考点</Text>
          </View>
        </TouchableOpacity>
        ...
        <TouchableOpacity style={styles.comingSoon} activeOpacity={0.8}>
          <Text style={styles.comingSoonText}>🔜 写作训练 敬请期待</Text>
        </TouchableOpacity>
      </View>
